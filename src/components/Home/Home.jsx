  ...
  return (
    <div className="mx-auto w-full max-w-7xl">
      ...
      <aside className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16 py-8">
        <div className="relative z-10 max-w-screen-xl px-4 sm:py-24 py-12 mx-auto sm:px-6 lg:px-8 flex flex-col-reverse sm:flex-row items-center sm:space-x-8 space-y-8 sm:space-y-0">
          {/* Text and Button */}
          <div className="text-center sm:text-left sm:max-w-lg space-y-6">
            <h2 className="text-4xl font-bold sm:text-5xl">
              Download Now
              <span className="block text-4xl sm:hidden">Lorem Ipsum</span>
            </h2>
            <p className="text-gray-600">
              Experience the best with our product. Download it now and see the
              difference.
            </p>
            <Link
